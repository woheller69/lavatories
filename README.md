...
- AndroidAddressFormatter library [AndroidAddressFormatter]https://github.com/woheller69/AndroidAddressFormatter licensed under <a href='https://github.com/woheller69/AndroidAddressFormatter/blob/master/LICENSE'>MIT License</a>, which is based upon the work of [OpenCage](https://github.com/OpenCageData/address-formatting/) and [Placemarkt](https://github.com/placemarkt/address-formatter-java) 
